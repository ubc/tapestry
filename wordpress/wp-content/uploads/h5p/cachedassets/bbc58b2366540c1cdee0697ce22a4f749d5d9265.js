...
H5P.BranchVideo = (function ($) {
  ...
  C.prototype.attach = function ($container) {
    ...
    var fullLink3 = this.options.branch3["0"].path;
    var regExp = /^.*(youtu.be\/|v\/|u\/\w\/|embed\/|watch\?v=|\&v=)([^#\&\?]*).*/;
    var match = fullLink.match(regExp);
    var match2 = fullLink2.match(regExp);
    var match3 = fullLink3.match(regExp);
    ...
    if (this.options.branch && this.options.branch3["0"].path) {
      $container.append('<iframe class="greeting-image" src="https://www.youtube.com/embed/' + vidID3 + '" frameborder="0" allowfullscreen> </iframe>');
    }
