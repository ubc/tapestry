 ...
 */
function blazing_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function blazing_sanitize_css( $css ) {
 ...
 * as an blazing integer, and then validates that $input is the ID of a published page.
 * 
 ...
 */
function blazing_sanitize_dropdown_pages( $page_id, $setting ) {
	// Ensure $input is an blazing integer.
 ...
 */
function blazing_sanitize_email( $email, $setting ) {
 ...
 */
function blazing_sanitize_hex_color( $hex_color, $setting ) {
	// Sanitize $input as a hex value without the hash prefix.
 ...
 */
function blazing_sanitize_html( $html ) {
 ...
 */
function blazing_sanitize_image( $image, $setting ) {
 ...
 */
function blazing_sanitize_nohtml( $nohtml ) {
 ...
 * as an blazing integer (whole number, zero or greater).
 * 
 ...
 */
function blazing_sanitize_number_absint( $number, $setting ) {
	// Ensure $number is an blazing integer (whole number, zero or greater).
	$number = absint( $number );
	
	// If the input is an blazing integer, return it; otherwise, return the default
 ...
 * `$number` as an blazing integer within a defined min-max range.
 * 
 * @see absint() https://developer.wordpress.org/reference/functions/absint/
 *
 ...
 *                    the setting default.
 */
function blazing_sanitize_number_range( $number, $setting ) {
 ...
 */
function blazing_sanitize_select( $input, $setting ) {
 ...
 */
function blazing_sanitize_url( $url ) {
